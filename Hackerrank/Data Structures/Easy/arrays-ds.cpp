...
*   Description:- Solution for HackerRank Arrays - DS problem
...
vector<int> reverseArray(vector<int> a) {
    ...
    /*
    *   Iterating the vector in reverse direction and
    *   pushing all elements one by one in the result vector
    */
