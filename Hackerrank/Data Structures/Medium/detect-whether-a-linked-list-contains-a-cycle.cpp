...
*   Description:- Solution for HackerRank Cycle Detection problem
...
bool has_cycle(SinglyLinkedListNode* head) {
    ...
    /*
    *   Loop while slow is not NULL,
    *   fast is not NULL as well as
    ...
    */
    while(slow!=NULL && fast!=NULL && fast->next!=NULL) {
        ...
        // * Move fast to node after the next node
        fast = fast->next->next;

        // * If slow and fast pointers are equal, return true
        if(slow == fast) {
            return true;
        }
    }
