...
*   Description:- Solution for HackerRank Simple Array Sum problem
...
int simpleArraySum(vector<int> ar) {
    ...
    /*
    *   Calculating the sum of array elements by iterating the array
    *   and adding each array value to sum
    */
