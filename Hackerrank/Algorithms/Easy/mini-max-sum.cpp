...
*   Description:- Solution for HackerRank Mini-Max Sum problem
...
void miniMaxSum(vector<int> arr) {
    ...
    long minA = INT_MAX, maxA = INT_MIN, sum = 0;

    /*
    *   Finding the minimum element of the array,
    *   maximum element of the array and sum of all elements
    *   of the array
    */
    for(long a : arr) {
        minA = min(minA, a);
